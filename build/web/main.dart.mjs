...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1627: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1628: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1629: x0 => globalThis.firebase_core.getApp(x0),
      _1630: () => globalThis.firebase_core.getApp(),
      _1641: (x0,x1) => globalThis.firebase_storage.getStorage(x0,x1),
      _1646: x0 => globalThis.firebase_storage.getDownloadURL(x0),
      _1650: (x0,x1) => globalThis.firebase_storage.ref(x0,x1),
      _1727: x0 => globalThis.firebase_storage.getStorage(x0),
      _1729: () => globalThis.firebase_core.SDK_VERSION,
      _1736: x0 => x0.apiKey,
      _1738: x0 => x0.authDomain,
      _1740: x0 => x0.databaseURL,
      _1742: x0 => x0.projectId,
      _1744: x0 => x0.storageBucket,
      _1746: x0 => x0.messagingSenderId,
      _1748: x0 => x0.measurementId,
      _1750: x0 => x0.appId,
      _1752: x0 => x0.name,
      _1753: x0 => x0.options,
      _1754: (x0,x1) => x0.debug(x1),
      _1755: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1755(f,arguments.length,x0) }),
      _1756: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1756(f,arguments.length,x0,x1) }),
      _1757: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1758: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1759: (x0,x1) => x0.createScriptURL(x1),
      _1760: (x0,x1,x2) => x0.createScript(x1,x2),
      _1761: (x0,x1) => x0.appendChild(x1),
      _1762: (x0,x1) => x0.appendChild(x1),
      _1763: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1763(f,arguments.length,x0) }),
      _1777: x0 => new Array(x0),
      _1779: x0 => x0.length,
      _1781: (x0,x1) => x0[x1],
      _1782: (x0,x1,x2) => x0[x1] = x2,
      _1785: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1787: x0 => new Int8Array(x0),
      _1788: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1789: x0 => new Uint8Array(x0),
      _1795: x0 => new Uint16Array(x0),
      _1797: x0 => new Int32Array(x0),
      _1799: x0 => new Uint32Array(x0),
      _1801: x0 => new Float32Array(x0),
      _1803: x0 => new Float64Array(x0),
      _1805: (o, c) => o instanceof c,
      ...
      _1835: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1836: () => new TextDecoder("utf-8", {fatal: true}),
      _1837: () => new TextDecoder("utf-8", {fatal: false}),
      _1838: x0 => new WeakRef(x0),
      _1839: x0 => x0.deref(),
      _1845: Date.now,
      _1847: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1848: s => {
      ...
      _1850: () => typeof dartUseDateNowForTicks !== "undefined",
      _1851: () => 1000 * performance.now(),
      _1852: () => Date.now(),
      _1855: () => new WeakMap(),
      _1856: (map, o) => map.get(o),
      _1857: (map, o, v) => map.set(o, v),
      _1858: () => globalThis.WeakRef,
      _1868: s => JSON.stringify(s),
      _1869: s => printToConsole(s),
      _1870: a => a.join(''),
      _1871: (o, a, b) => o.replace(a, b),
      _1873: (s, t) => s.split(t),
      _1874: s => s.toLowerCase(),
      _1875: s => s.toUpperCase(),
      _1876: s => s.trim(),
      _1877: s => s.trimLeft(),
      _1878: s => s.trimRight(),
      _1880: (s, p, i) => s.indexOf(p, i),
      _1881: (s, p, i) => s.lastIndexOf(p, i),
      _1882: (s) => s.replace(/\$/g, "$$$$"),
      _1883: Object.is,
      _1884: s => s.toUpperCase(),
      _1885: s => s.toLowerCase(),
      _1886: (a, i) => a.push(i),
      _1890: a => a.pop(),
      _1891: (a, i) => a.splice(i, 1),
      _1893: (a, s) => a.join(s),
      ...
      _1944: () => globalThis.performance,
      _1945: () => globalThis.JSON,
      _1946: x0 => x0.measure,
      _1947: x0 => x0.mark,
      _1948: x0 => x0.clearMeasures,
      _1949: x0 => x0.clearMarks,
      _1950: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1951: (x0,x1,x2) => x0.mark(x1,x2),
      _1952: x0 => x0.clearMeasures(),
      _1953: x0 => x0.clearMarks(),
      _1954: (x0,x1) => x0.parse(x1),
      _1955: (o, t) => o instanceof t,
      ...
      _1959: o => Object.keys(o),
      _1960: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1961: (handle) => clearTimeout(handle),
      _1962: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1963: (handle) => clearInterval(handle),
      _1964: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1965: () => Date.now(),
      _1966: () => new XMLHttpRequest(),
      _1967: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1968: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1969: (x0,x1) => x0.send(x1),
      _1971: x0 => x0.getAllResponseHeaders(),
      ...
      _1985: x0 => x0.trustedTypes,
      _1987: (x0,x1) => x0.text = x1,
      _2003: (s, m) => {
        try {
      ...
      _2097: (o, p) => o[p],
      _2098: (o, p, v) => o[p] = v,
      _2099: (o, p) => delete o[p],
      _2100: v => v.toString(),
      _2101: (d, digits) => d.toFixed(digits),
      _2104: (d, precision) => d.toPrecision(precision),
      _2105: x0 => x0.random(),
      _2106: x0 => x0.random(),
      _2110: () => globalThis.Math,
      _2205: (x0,x1) => x0.withCredentials = x1,
      _2207: x0 => x0.responseURL,
      _2208: x0 => x0.status,
      _2209: x0 => x0.statusText,
      _2211: (x0,x1) => x0.responseType = x1,
      _2212: x0 => x0.response,
      _3539: (x0,x1) => x0.type = x1,
      _3547: (x0,x1) => x0.crossOrigin = x1,
      _3549: (x0,x1) => x0.text = x1,
      _4024: () => globalThis.window,
      _4089: x0 => x0.navigator,
      _4351: x0 => x0.trustedTypes,
      _4480: x0 => x0.userAgent,
      _6806: () => globalThis.document,
      _6901: x0 => x0.head,
      _13755: () => globalThis.console,
      _13786: x0 => x0.name,
      _13787: x0 => x0.message,
      _13788: x0 => x0.code,
